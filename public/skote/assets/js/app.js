    ...
    function n(e) {
        document.getElementById("header-lang-img") &&
            ("en" == e
                ...
                : "ru" == e && (document.getElementById("header-lang-img").src = baseUrl + "assets/images/flags/russia.jpg"),
            localStorage.setItem("language", e),
            null == (t = localStorage.getItem("language")) && n(s),
            a.getJSON(baseUrl + "assets/lang/" + t + ".json", function (e) {
                a("html").attr("lang", t),
    ...
    function r(e) {
        1 == a("#light-mode-switch").prop("checked") && "light-mode-switch" === e
            ? (a("html").removeAttr("dir"),
              ...
              a("#bootstrap-style").attr("href", baseUrl + "assets/css/bootstrap.min.css"),
              a("body").attr("data-layout-mode", "light"),
              a("#app-style").attr("href", baseUrl + "assets/css/app.min.css"),
            ...
            ? (a("#light-mode-switch").prop("checked", !1),
              a("#dark-mode-switch").prop("checked", !1),
              a("#dark-rtl-mode-switch").prop("checked", !1),
              a("#bootstrap-style").attr("href", baseUrl + "assets/css/bootstrap-rtl.min.css"),
              a("#app-style").attr("href", baseUrl + "assets/css/app-rtl.min.css"),
              a("html").attr("dir", "rtl"),
              a("body").attr("data-layout-mode", "light"),
