                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('dashboard.bank_data.index') }}" class="btn btn-warning">Kembali</a>
                                </div>
                                <hr>
                                ...
                                <form class="row g-3 needs-validation myForm" method="POST"
                                    action="{{ route('dashboard.bank_data.update', $data->id) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($data->file)
                                            <br>
                                            <a class="btn btn-primary btn-sm" target="_blank" href="{{ url(Storage::url($data->file)) }}" alt="">
