            ...
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                            <a href="{{ route('dashboard.carousel.index') }}" class="btn btn-warning"><i class="fas fa-arrow-left"></i> Kembali</a>
                        </div>
                    </div>
                </div>
                <!-- end page title -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation myForm" method="POST"
                                    action="{{ route('dashboard.carousel.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-9">
                                        <label class="form-label">Link Carousel</label>
