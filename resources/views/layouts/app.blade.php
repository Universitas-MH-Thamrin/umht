        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box">
            <a href="index.html" class="logo logo-dark">
              ...
              <span class="logo-lg">
                <img src="{{ asset('img/logo.png') }}" style="background-color: white;padding:8px 4px 4px 4px;"
                  alt="" height="60">
              </span>
            </a>
        ...
        <div class="d-flex">
          ...
          <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
              data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img class="rounded-circle header-profile-user" src="{{ asset('img/fav.png') }}" alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              <a class="dropdown-item" href="{{ route('dashboard.user.profile') }}"><i
                  class="align-middle bx bx-user font-size-16 me-1"></i> <span key="t-profile">Profile</span></a>
            ...
            @if (in_array(Auth::user()->role, ['admin']))
              <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                  <li><a href="{{ route('dashboard.slider.index') }}" key="t-tui-paud">Slider/Banner</a></li>
                  <li><a href="{{ route('dashboard.carousel.index') }}" key="t-tui-paud">Carousel</a></li>
                  <li><a href="{{ route('dashboard.link_terkait.index') }}" key="t-tui-paud">Link Terkait</a></li>
                  ...
                  <li><a href="{{ route('dashboard.hero_banner.index') }}" key="t-tui-paud">Hero Banner</a></li>
              ...
              {{-- Akreditasi --}}
              <li>
                <a href="{{ route('dashboard.akreditasi.index') }}" class="waves-effect">
                  <i class="bx bx-medal"></i>
                  <span key="t-chat">Akreditasi</span>
                </a>
              </li>
