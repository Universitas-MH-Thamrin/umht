            ...
            <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                            <a href="{{ route('dashboard.faq.index') }}" class="btn btn-warning"><i
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation myForm" method="POST"
                                    action="{{ route('dashboard.faq.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="jawaban" cols="30" rows="4" class="ckeditor-classic">{{ old('jawaban') }}</textarea>
                                    </div>
                                    <div class="col-md-3">
