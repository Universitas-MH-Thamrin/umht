                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation myForm" method="POST"
                                    ...
                                    @method('PUT')
                                    <div class="col-md-12">
                                        <label class="form-label">Dropzone Upload Gambar ke {{ $data->nama }}</label>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="dropzone">
                                                    <div class="fallback">
                                                        <form method="post"
                                                            action="{{ route('dashboard.galeri.fileStore', $data->id) }}"
                                                            ...
                                                            <div class="border rounded">
                                                                <div class="d-flex p-2">
                                                                    <div class="flex-shrink-0 me-3">
                                                                        <div class="avatar-sm bg-light rounded">
                                                                            <img data-dz-thumbnail
                                                                                ...
                                                                                src="{{ ($item->file ? (MyHelper::is_image($item->file) ? url(Storage::url($item->file)) : asset('img/galeri.png'))  : asset('img/new-document.png')) }}"
                                                                                alt="{{ $item->nama }}"/>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="flex-shrink-0 ms-3">
                                                                        <form
                                                                            action="{{ route('dashboard.galeri.fileDestroyReload') }}"
                                                                            method="POST">
                                                                            @csrf
    ...
    <script>
        ...
        dropzonePreviewNode.id = "", dropzonePreviewNode && (previewTemplate = dropzonePreviewNode.parentNode.innerHTML,
            dropzonePreviewNode.parentNode.removeChild(dropzonePreviewNode), dropzone = new Dropzone(".dropzone", {
                url: "{{ route('dashboard.galeri.fileStore', $data->id) }}",
                method: "post",
                headers: {
                ...
                removedfile: function(file) {
                    ...
                    $.ajax({
                        ...
                        type: 'POST',
                        url: "{{ route('dashboard.galeri.fileDestroy') }}",
                        data: {
                            filename: filename
                        },
