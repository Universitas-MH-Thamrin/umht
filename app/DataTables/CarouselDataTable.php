...
class CarouselDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('tombol', function($data) {
                return "<a href='". $data->btn_link ."' target='_blank' class='btn btn-sm btn-primary'>Selengkapnya</a>";
            })
            ...
            ->addColumn('action', function($data) {
                return "
                    <div class='d-flex justify-content-center'>
                        <a href='" . route('dashboard.carousel.edit', $data->id) . "' class='btn btn-sm btn-warning me-1'>
                        <i class='mdi mdi-pencil align-middle font-size-12'></i> Edit
                        </a>
                        <form action='" . route('dashboard.carousel.destroy', $data->id) . "' method='post' style='display: inline-block;'>
                            " . csrf_field() . "
                            " . method_field('DELETE') . "
     ...
     *
     * @param \App\Models\CarouselDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('Carouseldatatable-table')
